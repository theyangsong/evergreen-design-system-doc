...
export const dataTableEditDocPath = '/organisms/data-table-edit';

export const dataTableEditDocPage = defineComponentDocPage({
  path: dataTableEditDocPath,
  sectionId: 'organisms',
  title: 'Data Table Edit',
  description: 'Data Table Edit 的设计与开发指南。',
  meta: [
    { label: '名称', value: 'Data Table Edit' },
    { label: 'ID', value: 'eds-org-data-table-edit' },
    { label: '类型', value: '基础组件' },
    { label: '状态', value: '已启用' },
    { label: '版本', value: '1.0' },
