...
export const dataTableViewDocPath = '/organisms/data-table-view';

export const dataTableViewDocPage = defineComponentDocPage({
  path: dataTableViewDocPath,
  sectionId: 'organisms',
  title: 'Data Table View',
  description: 'Data Table View 的设计与开发指南。',
  meta: [
    { label: '名称', value: 'Data Table View' },
    { label: 'ID', value: 'eds-org-data-table-view' },
    { label: '类型', value: '基础组件' },
    { label: '状态', value: '已启用' },
    { label: '版本', value: '1.0' },
  ...
  imageAssetDir: 'organisms/data-table-view',
  bundles: {
    design: {
