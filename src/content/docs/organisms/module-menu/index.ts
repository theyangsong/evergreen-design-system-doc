...
export const moduleMenuDocPath = '/organisms/module-menu';

export const moduleMenuDocPage = defineComponentDocPage({
  path: moduleMenuDocPath,
  sectionId: 'organisms',
  title: 'Module Menu',
  description: 'Module Menu 的设计与开发指南。',
  meta: [
    { label: '名称', value: 'Module Menu' },
    { label: 'ID', value: 'eds-org-module-menu' },
    { label: '类型', value: '基础组件' },
    { label: '状态', value: '已启用' },
    { label: '版本', value: '1.0' },
  ...
  imageAssetDir: 'organisms/module-menu',
  bundles: {
    design: {
