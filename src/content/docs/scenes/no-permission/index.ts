...
export const noPermissionDocPath = '/scenes/no-permission';

export const noPermissionDocPage = defineComponentDocPage({
  path: noPermissionDocPath,
  sectionId: 'scenes',
  title: 'No Permission',
  description: 'No Permission 的设计与开发指南。',
  meta: [
    { label: '名称', value: 'No Permission' },
    { label: 'ID', value: 'eds-biz-no-permission' },
    { label: '类型', value: '业务组件' },
    { label: '状态', value: '已启用' },
    { label: '版本', value: '1.0' },
  ...
  imageAssetDir: 'scenes/no-permission',
  bundles: {
    design: {
