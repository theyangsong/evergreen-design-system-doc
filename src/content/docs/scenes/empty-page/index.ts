...
export const emptyPageDocPath = '/scenes/empty-page';

export const emptyPageDocPage = defineComponentDocPage({
  path: emptyPageDocPath,
  sectionId: 'scenes',
  title: 'Empty Page',
  description: 'Empty Page 的设计与开发指南。',
  meta: [
    { label: '名称', value: 'Empty Page' },
    { label: 'ID', value: 'eds-biz-empty-page' },
    { label: '类型', value: '业务组件' },
    { label: '状态', value: '已启用' },
    { label: '版本', value: '1.0' },
  ...
  imageAssetDir: 'scenes/empty-page',
  bundles: {
    design: {
