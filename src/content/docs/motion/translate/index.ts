...
export const translateDocPath = '/motion/translate';

export const translateDocPage = defineComponentDocPage({
  path: translateDocPath,
  sectionId: 'motion',
  title: '位移',
  description: '位移 的设计与开发指南。',
  meta: [
    { label: '名称', value: '位移' },
    { label: 'ID', value: 'eds-motion-translate' },
  ...
  imageAssetDir: 'motion/translate',
  bundles: {
    design: {
