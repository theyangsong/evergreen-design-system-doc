...
export const pageTransitionDocPath = '/motion/page-transition';

export const pageTransitionDocPage = defineComponentDocPage({
  path: pageTransitionDocPath,
  sectionId: 'motion',
  title: '页面切换',
  description: '页面切换 的设计与开发指南。',
  meta: [
    { label: '名称', value: '页面切换' },
    { label: 'ID', value: 'eds-motion-page-transition' },
  ...
  imageAssetDir: 'motion/page-transition',
  bundles: {
    design: {
