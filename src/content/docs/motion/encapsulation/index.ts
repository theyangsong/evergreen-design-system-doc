...
export const encapsulationDocPath = '/motion/encapsulation';

export const encapsulationDocPage = defineComponentDocPage({
  path: encapsulationDocPath,
  sectionId: 'motion',
  title: '封装',
  description: '封装 的设计与开发指南。',
  meta: [
    { label: '名称', value: '封装' },
    { label: 'ID', value: 'eds-motion-encapsulation' },
  ...
  imageAssetDir: 'motion/encapsulation',
  bundles: {
    design: {
